...
# IMPORTANT
def draw_pad():
    glColor3f(1.0, 0.0, 1.0)  # Magenta for the top paddle
    #T
    draw_line_midpoint(pad_x, pad_y, pad_x + PAD_WIDTH, pad_y)
    draw_line_midpoint(pad_x, pad_y + PAD_HEIGHT, pad_x + PAD_WIDTH, pad_y + PAD_HEIGHT)
    #L
    draw_line_midpoint(pad_x, pad_y, pad_x, pad_y + PAD_HEIGHT)
    draw_line_midpoint(pad_x + PAD_WIDTH, pad_y, pad_x + PAD_WIDTH, pad_y + PAD_HEIGHT)

def draw_pad2():
    glColor3f(0.0, 1.0, 0.0)  # Green for the bottom paddle
    # TB
    draw_line_midpoint(pad2_x, pad2_y, pad2_x + PAD_WIDTH, pad2_y)
    draw_line_midpoint(pad2_x, pad2_y + PAD_HEIGHT, pad2_x + PAD_WIDTH, pad2_y + PAD_HEIGHT)
    #LR
    draw_line_midpoint(pad2_x, pad2_y, pad2_x, pad2_y + PAD_HEIGHT)
    draw_line_midpoint(pad2_x + PAD_WIDTH, pad2_y, pad2_x + PAD_WIDTH, pad2_y + PAD_HEIGHT)
